...
{
public:
	CMagma(); //Default session number = 1
	~CMagma();
...
protected:
	void InitN(unsigned __int64 Message);
	void InitResult(void);
	void EncryptFunction(char KeyNumber);

public:
	unsigned __int64 StartNewSession(unsigned __int64 Nonce);
	unsigned __int64 Encrypt(unsigned __int64 Message);
	unsigned __int64 Decrypt(unsigned __int64 Message);

public:
	bool CheckMagma(unsigned __int64 CheckMessage, unsigned __int64 CheckNonce); //Only then Magma stoped
};
